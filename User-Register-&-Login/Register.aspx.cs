    ...
    public partial class Register : System.Web.UI.Page
    {
        ...
        protected void btnreg_Click1(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                SqlCommand cmd = new SqlCommand("insert into user_login(user_email,user_name,user_pass,user_passconfirm) values('"+txtemailid.Text+"','" + txtusername.Text + "','" + txtpass.Text + "','" + txtpassconfirm.Text + "')", con);
                cmd.ExecuteNonQuery();
                if (IsPostBack)
                {
