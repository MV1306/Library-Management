    ...
    <div align="center" class="container jumbotron bg-light boxshadow" style="width:35%;margin-top:inherit;">
            ...
            <div class="form-group" style="width:80%">
                <label class="text-dark" for="phonelabel">Phone Number</label>
                    <asp:TextBox ID="txtphno" runat="server" CssClass="form-control" TextMode="Phone"></asp:TextBox>
            ...
            <div class="form-group" style="width:80%">
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ErrorMessage="Invalid Username. Only alphabets &amp; numbers allowed.Length: 6-15 characters" ControlToValidate="txtusername" ForeColor="Red" ValidationExpression="^[a-zA-Z0-9'\s]{6,15}$" Display="Dynamic"></asp:RegularExpressionValidator>
                </div>
