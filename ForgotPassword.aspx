...
<body style="background-image:url('Forgot.jpeg');background-repeat:no-repeat;background-size:cover;">
    ...
    <div align="center" class="container jumbotron bg-light boxshadow" style="width:35%;margin-top:inherit;">
            ...
            <div class="form-group" style="width:80%">
                <label class="text-dark" for="userlabel">Email ID</label>
                    <asp:TextBox ID="txtemailchng" runat="server" CssClass="form-control" TextMode="Email"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Email ID Required" ForeColor="Red" Display="Dynamic" ControlToValidate="txtemailchng"></asp:RequiredFieldValidator>
                </div>
